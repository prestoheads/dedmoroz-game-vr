if (b4w.module_check("dummy_presents"))
    throw "Failed to register module: dummy_presents";

b4w.register("dummy_presents", function(exports, require) {
...
var _presents_generation_marker = m_vec3.create();
...
function generate_present(x, y, z, present_ind, type_ind) {
    //console.log("!!!", _presents_source[type_ind]);
...
exports.setup_presents_generation = function (elapsed_sensor) {
    ...
    var dist_current = 0;
    var presents_generation_object = m_scs.get_object_by_name("character_collider");
    //var _presents_generation_marker = m_trans.get_translation(
    //    presents_generation_object, _presents_generation_marker
    //);

    function generate_cb(obj, id) {
        elapsed = m_ctl.get_sensor_value(obj, id, 0);
        //console.log(_presents_generation_marker);
        //if(!(m_train.get_wrapper() === null)) {
            _presents_generation_marker = window._presents_generation_marker;

            if(!_presents_generation_marker){
                return;
            }
