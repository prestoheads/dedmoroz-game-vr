if (b4w.module_check("dummy_bat"))
    throw "Failed to register module: presents";

b4w.register("dummy_bat", function(exports, require) {
...
exports.setup_bats_generation = function (elapsed_sensor) {
    _bats_generation_marker = window._presents_generation_marker;
