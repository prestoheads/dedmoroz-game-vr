...
exports.FLY_VELOCITY = 3;
exports.CAM_OFFSET = new Float32Array([0, 0, 0]);
...
//exports.TUNNEL_MAX_DIST = 200;

exports.TUNNEL_FORCE_CLIP = [2, 1, 1.2];

exports.ROTATION_CLIP_H = 0.5;
exports.ROTATION_CLIP_V = 0.45;
exports.ROTATION_CLIP_H = 0.5*Math.PI;
exports.ROTATION_CLIP_V = 0.5*Math.PI;
...
// HMD
exports.HMD_POS_INIT_OFFSET				= m_vec3.fromValues(0, 0, 0);
exports.HMD_POS_SHARPEN_FACTOR			= 1;
exports.HMD_ROT_INIT_OFFSET				= m_quat.create();
m_quat.rotateZ(m_quat.fromValues(0, 0, 0, 1), Math.PI, exports.HMD_ROT_INIT_OFFSET);

// Controllers
exports.CONTROLLER_SHARPEN_FACTOR		= 0.5;
